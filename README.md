...
- DOM and event telemetry, including native request method/status metadata, redirects, failures, response headers, duration, transferred bytes, and aggregate breakdowns by domain, method, MIME type, status code, and error signature
