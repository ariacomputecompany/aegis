...
- DOM and event telemetry, including native request method/status metadata, redirects, failures, response headers, duration, transferred bytes, and per-domain network aggregates
